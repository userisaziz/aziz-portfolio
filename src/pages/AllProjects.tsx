...
import { Play, ExternalLink, Github, Eye, Code, Zap, Star, ArrowUpRight, Home, FolderOpen } from 'lucide-react';
...
const AllProjects = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20">
      ...
      <header className="pt-20 py-8 border-b border-border/50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div>
              <h1 className="font-bricolage text-4xl lg:text-6xl font-bold mb-4">
                <span className="gradient-text">All Projects</span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-2xl">
                Explore my complete portfolio of {projects.length} projects showcasing expertise across 
          ...
          >
                    ...
                    <div className="p-6">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-center">
                        <div>
                          ...
                          <div className="text-sm font-semibold">{project.metrics.performance.split(' ')[0]}</div>
                        </div>
                        <div>
                          <div className="text-xs text-muted-foreground">Users</div>
                          <div className="text-sm font-semibold">{project.metrics.users.split(' ')[0]}</div>
                        </div>
                        <div>
                          <div className="text-xs text-muted-foreground">Impact</div>
                          <div className="text-sm font-semibold">{project.metrics.impact.split(' ')[0]}</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <motion.div variants={itemVariants} className="text-center">
              <div className="glass-card p-8 rounded-3xl max-w-4xl mx-auto">
                <h2 className="font-bricolage text-2xl font-bold mb-6">Portfolio Statistics</h2>
